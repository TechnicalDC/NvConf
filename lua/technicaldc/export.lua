...
statusbar.font = 14pt FantasqueSansM Nerd Font
statusbar.bg = ${bg_mid}
statusbar.fg = ${fg}
statusbar.error = ${red}
...
statusbar.padding = 4
thumbnail.font = 14pt FantasqueSansM Nerd Font
thumbnail.fg = ${fg}
thumbnail.bg = ${bg}
...
prompt.font = 14pt FantasqueSansM Nerd Font
prompt.fg = #282a2e
prompt.bg = #d6d6d6
prompt.padding = 2px
