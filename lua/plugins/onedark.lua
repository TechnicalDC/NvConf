   ...
   config = function ()
      require('onedark').setup  {
         ...
         highlights = {
            ...
            ["BufferLineBufferSelected"] = { fmt = "italic" },
            ["TelescopeSelectionCaret"] = { bg = "#30363f" },
            ["TelescopeBorder"] = { fg = "#535965" },
            ["TelescopePromptBorder"] = { fg = "#535965" },
            ["TelescopeResultsBorder"] = { fg = "#535965" },
            ["TelescopePreviewBorder"] = { fg = "#535965" },
